 <footer id="colophon" class="site-footer footer-v1" >
            <div class="col-full">
               ...
               <div class="footer-logo">
                  <a href="<?= base_url('');?>" class="custom-logo-link" rel="home">
                     <h2 id="logotext"><img src="<?= base_url('assets/user/images/fulllogo.png'); ?>" alt="Krispy Chicken" style="width: 195px;height: 52px" class="img-responsive" alt="Krispy Chicken"></h2>
            <!--          <svg class="pizzaro-logo" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 52.39">
               ...
               <div class="site-address">
                  <ul class="address">
                     ...
                     <li>Shop No 5, Abdullah Khamis Building 
                  Mankhool Road, Satwa, Dubai UAE</li>
                     <li>Telephone: 043 995 567</li>
                     <!-- <li>Fax: 043 995 567</li> -->
                  </ul>
               </div>
               <div class="site-info">
                  <p class="copyright">Copyright &copy; 2017 Krispy Chicken. All rights reserved.</p>
               </div>
               <!-- .site-info -->      
               <a role="button" class="footer-action-btn" data-toggle="collapse" href="<?= base_url('locate') ?>">
                  <i class="po po-map-marker"></i>Find us on Map</a>
             <div class="pizzaro-handheld-footer-bar">
                  <ul class="columns-3">
                     ...
                     <li class="cart"><a class="footer-cart-contents" href="cart.php" title="View your shopping cart"><span class="count">2</span></a></li>
                  </ul>
               </div>
            </div>
            <!-- .col-full -->
      ...
      <script type="text/javascript" src="<?= base_url('assets/user/js/tether.min.js');?>"></script>
      <script type="text/javascript" src="<?= base_url('assets/user/js/bootstrap.min.js');?>"></script>
      <script type="text/javascript" src="<?= base_url('assets/user/js/owl.carousel.min.js');?>"></script>

      <script type="text/javascript" src="<?= base_url('assets/user/js/social.share.min.js');?>"></script>
      <script type="text/javascript" src="<?= base_url('assets/user/js/jquery.mCustomScrollbar.concat.min.js');?>"></script>
      <script type="text/javascript" src="<?= base_url('assets/user/js/scripts.min.js');?>"></script>
      <!-- For demo purposes – can be removed on production -->
      <script src="<?= base_url('assets/user/switchstylesheet/switchstylesheet.js');?>"></script>
      <!-- For demo purposes – can be removed on production : End -->