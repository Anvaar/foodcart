                              ...
                              <form>
                                 <table class="shop_table shop_table_responsive cart" >
                                    ...
                                    <tbody>
                                       ...
                                       <?php if(count($products)) : ?>
                                          ...
                                          <td class="product-remove">
                                             <a href="<?= base_url("cart?id=$product->cart_id&request=remove"); ?>" class="remove" >&times;</a>
                                          </td>
                                          <td class="product-thumbnail">
                                             <a href="single-product-v1.html">
                                             <img width="180" height="180" src="<?= base_url('assets/user/images/products/1.png');?>" alt=""/>
                                             </a>
                                          </td>
                                          <td class="product-name" data-title="Product">
                                             <a href="single-product-v1.html"><?= $product->cart_title; ?></a>
                                             <dl class="variation">
                                                <dt class="variation-Baseprice">Base price:</dt>
                                                <dd class="variation-Baseprice">
                                                   <p><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#036;</span><?= $product->cart_price; ?></span></p>
                                                </dd>
                                          ...
                                          <td class="product-price" data-title="Price">
                                             <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">&#36;</span><?= $product->cart_price; ?></span>
                                          </td>
                                          <td class="product-quantity" data-title="Quantity">
                                             <div class="qty-btn">
                                                <label>Quantity</label>
                                                <div class="quantity">
                                                   <input type="number" value="<?= $product->cart_qty; ?>" title="Qty" class="input-text qty text"/>
                                                </div>
                                             </div>
                                          </td>
                                    ...
                                    <?php endforeach; ?>
                                       <?php else : ?>
                                             <tr class="cart_item">
                                                <p>No Product is in your Cart.</p>
                                             </tr>
                                       <?php endif; ?>
                                       ...
                                       <tr class="cart_item hidden">
                                          ...
                                          <td class="product-thumbnail">
                                             <a href="single-product-v1.php">
                                             <img width="180" height="180" src="<?= base_url('assets/user/images/products/min/p19.jpg');?>" alt="" />
                                             </a>
                                          </td>
                                          <td class="product-name" data-title="Product">
