...
<html lang="en-US" itemscope="itemscope" itemtype="http://schema.org/WebPage">
   ...
   <body class="home-v5 page-template-template-homepage-v5 woocommerce-active">
               ...
               <nav id="site-navigation" class="main-navigation"  aria-label="Primary Navigation">
                  ...
                  <div class="primary-navigation">
                     <ul id="menu-home-5-and-7-main-menu" class="menu nav-menu" aria-expanded="false">
                        <li class="current-menu-item menu-item"><a href="index.html">Home</a></li>
                                                   ...
                                                   <div class="widget widget_nav_menu kc-elm kc-css-3447423">
                                                      <div class="menu-pages-menu-4-container">
                                                         <ul id="menu-pages-menu-8" class="menu">
                                                            ...
                                                            <li class="menu-item menu-item-625"><a href="404.html">404</a></li>
                                                         </ul>
                                                      </div>
                                                   </div>
                                                </div>
                        ...
                        <li class="menu-item"><a href="shop-grid-3-column.html">Best Deals</a></li>
                        <li class="menu-item"><a href="about.html">About Us</a></li>
                        <li class="menu-item"><a href="contact.html">Contact</a></li>
                              ...
                              <ul class="cart_list product_list_widget ">
                                 <li class="mini_cart_item">
                                    ...
                                    <a href="single-product-v1.html">
                                       <img alt="" width="180" height="180" src="assets/images/products/mini.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image">Chicken Hawaii&nbsp;</a>
                                    <dl class="variation">
                  ...
                  <div class="stretch-full-width">
                     <main id="main" class="site-main" >
                           ...
                           <div class="categories">
                              <div class="category">
                                 <a href="shop-grid-4-column.html">
                                    <img src=" assets/images/homepage-banners/21.jpg " alt="Pizza" />
                                    <div class="caption">
                                       <h4>Pizza</h4>
                                    </div>
                                 </a>
                              ...
                              <div class="category">
                                 <a href="shop-grid-4-column.html">
                                    <img src=" assets/images/homepage-banners/22.jpg " alt="Burgers" />
                                    <div class="caption">
                                       <h4>Burgers</h4>
                                    </div>
                                 </a>
                              ...
                              <div class="category">
                                 <a href="shop-grid-4-column.html">
                                    <img src=" assets/images/homepage-banners/23.jpg " alt="Pasta" />
                                    <div class="caption">
                                       <h4>Pasta</h4>
                                    </div>
                                 </a>
                              ...
                              <div class="category">
                                 <a href="shop-grid-4-column.html">
                                    <img src=" assets/images/homepage-banners/24.jpg " alt="Salads &amp; Fit" />
                                    <div class="caption">
                                       <h4>Salads &amp; Fit</h4>
                                    </div>
                                 </a>
                        ...
                        <div class="banner center-right" >
                           <a href="#">
                              <div class="banner-bg" style="background-size: cover; background-position: center center; background-image: url( assets/images/homepage-banners/25.jpg ); height: 725px;">
                                 <div class="caption">
                                    ...
                                    <div class="description">
                                       ...
                                       <div class="text">FOR PIZZA ON MONDAYS</div>
                                    </div>
                        ...
                        <section class="newsletter-subscription"  style="background-size: cover; background-position: center center; background-image: url( assets/images/homepage-banners/26.jpg ); height: 460px;">
                           <div class="caption">
