                  ...
                  <main id="main" class="site-main">
                     <div class="home-v1-slider" >
                        <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                           <div class="item slider-1" style="background-image: url(<?= base_url('assets/user/images/slider/homepage-slider-10-min.jpg');?>);">
                             <!--  <div class="caption fadeIn hidden">
                                 <div class="pre-title">
                           ...
                           <!-- /.item -->
                           <div class="item slider-2" style="background-image: url(<?= base_url('assets/user/images/slider/homepage-slider-11-min.jpg');?>);">
                             <!--  <div class="caption fadeIn">
                                 ...
                                 <div class="sub-title">BURGER LOVERS SET</div>
                              </div> -->
                              <!-- /.caption -->
                           </div>
                           <!-- /.item -->
                           <div class="item slider-3" style="background-image: url(<?= base_url('assets/user/images/slider/homepage-slider-12-min.jpg');?>);">
                            <!--   <div class="caption fadeIn">
                           ...
                           <!-- /.item -->
                           <div class="item slider-4" style="background-image: url(<?= base_url('assets/user/images/slider/homepage-slider-13-min.jpg');?>);">
                             <!--  <div class="caption fadeIn">
                     ...
                     <div class="tiles">
                        <div class="row">
                           <div class="col-md-4">
                                 <img src="<?= base_url('assets/user/images/products/min/4.jpg');?>" alt="" class="img-responsive">
                           </div>
                           <div class="col-md-4">
                              <img src="<?= base_url('assets/user/images/products/min/1.jpg');?>" alt="" class="img-responsive">
                           </div>
                           <div class="col-md-4">
                              <img src="<?= base_url('assets/user/images/products/min/3.jpg');?>" alt="" class="img-responsive">
                           </div>
                         <!--   <div class="col-xs-12 col-sm-6">
                              <div class="banner top-left" >
                                 <a href="#">
                                    <div class="banner-bg" style="background-size: cover; background-position: center center; background-image: url(<?= base_url('assets/user/images/homepage-banners/6.jpg');?>); height: 442px;">
                                       <div class="caption">
                           ...
                           <div class="col-xs-12 col-sm-6">
                              <div class="banners">
                                 <div class="row">
                                    <div class="banner col-sm-6 top-right" >
                                       <a href="#">
                                          <div class="banner-bg" style="background-size: cover; background-position: center center; background-image: url(<?= base_url('assets/user/images/homepage-banners/2.jpg');?>); height: 210px;">
                                             <div class="caption">
                                    ...
                                    <div class="banner col-sm-6 top-right" >
                                       <a href="#">
                                          <div class="banner-bg" style="background-size: cover; background-position: center center; background-image: url( <?= base_url('assets/user/images/homepage-banners/3.jpg');?>); height: 210px;">
                                             <div class="caption">
                              ...
                              <div class="banner center" >
                                 <a href="#">
                                    <div class="banner-bg" style="background-size: cover; background-position: center center; background-image: url( <?= base_url('assets/user/images/homepage-banners/4.jpg');?>); height: 210px;">
                                       <div class="caption">
                     ...
                     <div class="section-tabs">
                        <ul class="nav nav-tabs pizzaro-nav-tabs" >
                           <li class="nav-item">
                              <a href="#h1-tab-products-1" data-toggle="tab">Fried Chicken</a>
                           </li>
                           <li class="nav-item active">
                              <a href="#h1-tab-products-2" class="active" data-toggle="tab">Burgers</a>
                           </li>
                           <li class="nav-item">
                              <a href="#h1-tab-products-3" data-toggle="tab">Starter</a>
                           </li>
                        </ul>
                                             ...
                                             <div class="product-outer">
                                                <div class="product-inner">
                                                   <div class="product-image-wrapper">
                                                      <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                                                      <img src="<?= base_url('assets/user/images/products/min/3.jpg');?>" class="img-responsive" alt="">
                                                      </a>
                                                   </div>
                                                   <div class="product-content-wrapper">
                                                      ...
                                                      <div class="hover-area">
                                                         <a rel="nofollow" href="single-product-v1.php" data-quantity="1" data-product_id="51" data-product_sku="" class="button product_type_simple add_to_cart_button ajax_add_to_cart">Add to cart</a>
                                                      </div>
                                                   </div>
                                                </div>
                                             </div>
                                          ...
                                          <li class="product ">
                                             <div class="product-outer">
                                                <div class="product-inner">
                                                   <div class="product-image-wrapper">
                                                      <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                                                      <img src="<?= base_url('assets/user/images/products/min/4.jpg');?>" class="img-responsive" alt="">
                                                      </a>
                                                   </div>
                                                   <div class="product-content-wrapper">
                                                      <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                                          ...
                                          <li class="product last">
                                             <div class="product-outer">
                                                <div class="product-inner">
                                                   <div class="product-image-wrapper">
                                                      <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                                                      <img src="<?= base_url('assets/user/images/products/min/5.jpg');?>" class="img-responsive" alt="">
                                                      </a>
                                                   </div>
                                                   <div class="product-content-wrapper">
                                                      <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                                          ...
                                          <li class="product first">
                                             <div class="product-outer">
                                                <div class="product-inner">
                                                   <div class="product-image-wrapper">
                                                      <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                                                      <img src="<?= base_url('assets/user/images/products/min/24.jpg');?>" class="img-responsive" alt="">
                                                      </a>
                                                   </div>
                                                   <div class="product-content-wrapper">
                                                      <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                                          ...
                                          <li class="product ">
                                             <div class="product-outer">
                                                <div class="product-inner">
                                                   <div class="product-image-wrapper">
                                                      <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                                                      <img src="<?= base_url('assets/user/images/products/min/28.jpg');?>" class="img-responsive" alt="">
                                                      </a>
                                                   </div>
                                                   <div class="product-content-wrapper">
                                                      <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                                          ...
                                          <li class="product last">
                                             <div class="product-outer">
                                                <div class="product-inner">
                                                   <div class="product-image-wrapper">
                                                      <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                                                      <img src="<?= base_url('assets/user/images/products/min/26.jpg');?>" class="img-responsive" alt="">
                                                      </a>
                                                   </div>
                                                   <div class="product-content-wrapper">
                                                      <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                                          ...
                                          <li class="product first">
                                             <div class="product-outer">
                                                <div class="product-inner">
                                                   <div class="product-image-wrapper">
                                                      <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                                                      <img src="<?= base_url('assets/user/images/products/min/35.jpg');?>" class="img-responsive" alt="">
                                                      </a>
                                                   </div>
                                                   <div class="product-content-wrapper">
                                                      <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                                          ...
                                          <li class="product ">
                                             <div class="product-outer">
                                                <div class="product-inner">
                                                   <div class="product-image-wrapper">
                                                      <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                                                      <img src="<?= base_url('assets/user/images/products/min/44.jpg');?>" class="img-responsive" alt="">
                                                      </a>
                                                   </div>
                                                   <div class="product-content-wrapper">
                                                      <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                                          ...
                                          <li class="product last">
                                             <div class="product-outer">
                                                <div class="product-inner">
                                                   <div class="product-image-wrapper">
                                                      <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                                                      <img src="<?= base_url('assets/user/images/products/min/45b.jpg');?>" class="img-responsive" alt="">
                                                      </a>
                                                   </div>
                                                   <div class="product-content-wrapper">
                                                      <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                     ...
                     <div class="stretch-full-width section-products-sale-event"  style="background-size: cover; background-position: center center; background-image: url( <?= base_url('assets/user/images/homepage-banners/7.jpg');?> ); height: 468px;">
                        <div class="sale-event-content">
                           ...
                           <a href="single-product-v1.php" class="button">Order Now</a>
                        </div>
                     </div>
                     <div class="section-products">
                              ...
                              <li class="product first">
                                 <div class="product-outer">
                                    <div class="product-inner">
                                       <div class="product-image-wrapper">
                                          <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                                          <img src="<?= base_url('assets/user/images/products/min/15.jpg');?>" class="img-responsive" alt="">
                                          </a>
                                       </div>
                                       <div class="product-content-wrapper">
                                          <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                              ...
                              <li class="product ">
                                 <div class="product-outer">
                                    <div class="product-inner">
                                       <div class="product-image-wrapper">
                                          <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                                          <img src="<?= base_url('assets/user/images/products/min/16.jpg');?>" class="img-responsive" alt="">
                                          </a>
                                       </div>
                                       <div class="product-content-wrapper">
                                          <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                              ...
                              <li class="product ">
                                 <div class="product-outer">
                                    <div class="product-inner">
                                       <div class="product-image-wrapper">
                                          <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                                          <img src="<?= base_url('assets/user/images/products/min/17.jpg');?>" class="img-responsive" alt="">
                                          </a>
                                       </div>
                                       <div class="product-content-wrapper">
                                          <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                     ...
                     <!-- <div class="section-product"  style="background-size: cover; background-image: url( assets/images/homepage-banners/6.png ); height: 556px;">
                        <div class="product-wrapper">
                           <div class="product-inner">
                              ...
                              <a rel="nofollow" href="single-product-v1.php" data-quantity="1" data-product_id="82" data-product_sku="" class="button product_type_simple add_to_cart_button ajax_add_to_cart">Add to cart</a>
                           </div>
                        </div>
                     </div> -->
