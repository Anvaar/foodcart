...
<div class="col-full">
	<div class="row pull-right clearfix" style="top:0px;color:white;margin-right: 10px;">
                   	<ul list-style="none" id="topmainlinks">
               ...
               <div class="header-wrap">
                   ...
                   <div class="site-branding">
                      <a href="<?= base_url(''); ?>" class="custom-logo-link" rel="home">
                        <img src="<?= base_url('assets/user/images/fulllogow.png'); ?>" alt="Krispy Chicken" class="img-responsive" style="">
                        <!-- <h1 id="logotext">Krispy Chicken</h1> -->
      <!--                    <svg class="pizzaro-logo" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 52.39">
                   ...
                   <nav id="site-navigation" class="main-navigation"  aria-label="Primary Navigation">
                      ...
                      <div class="primary-navigation">
                         <ul id="menu-main-menu" class="menu nav-menu" aria-expanded="false">
                            ...
                            <!--  <li class="menu-item"><a href="shop-grid-3-column.php">Order Online</a></li> -->
                            
                            <!-- <li class="menu-item"><a href="blog.php">News</a></li> -->
                            <li class="menu-item"><a href="<?= base_url('locate'); ?>">Locate</a></li>
                            <li class="menu-item"><a href="<?= base_url('socialresponsibility'); ?>">Social Responsibilty</a></li>
                         </ul>
                      </div>
                      <div class="handheld-navigation">
                         <span class="phm-close">Close</span>
                         <ul  class="menu">
                            <li class="menu-item "><a href="<?= base_url('products'); ?>"><i class="po po-pizza"></i>Pizza</a></li>
                            <li class="menu-item "><a href="<?= base_url('products'); ?>"><i class="po po-burger"></i>Burgers</a></li>
                            <li class="menu-item "><a href="<?= base_url('products'); ?>"><i class="po po-salads"></i>Salads</a></li>
                            <li class="menu-item "><a href="<?= base_url('products'); ?>"><i class="po po-tacos"></i>Tacos</a></li>
                            <li class="menu-item "><a href="<?= base_url('products'); ?>"><i class="po po-wraps"></i>Wraps</a></li>
                            <li class="menu-item "><a href="<?= base_url('products'); ?>"><i class="po po-fries"></i>Fries</a></li>
                            <li class="menu-item "><a href="<?= base_url('products'); ?>"><i class="po po-salads"></i>Salads</a></li>
                            <li class="menu-item "><a href="<?= base_url('products'); ?>"><i class="po po-drinks"></i>Drinks</a></li>
                         </ul>
                      </div>
                   </nav>
                   ...
                   <div class="header-info-wrapper">
                      <div class="header-phone-numbers">
                         <span class="intro-text">Call and Orders at</span>
                        <!--  <select class="select-city-phone-numbers" name="city-phone-numbers" id="city-phone-numbers">
                            <option value="123 345 5678">Uae</option>
                            <option value="33 398 621 710">Paris</option>
                            <option value="718 54 674 021">New York</option>
                         </select>  -->
                         <span id="city-phone-number-label" class="phone-number">043 995 567</span>
                      </div>
                      <ul class="site-header-cart-v2 menu">
                         <li class="cart-content ">
                            <a href="<?= base_url('cart'); ?>" title="View your shopping cart">
