            ...
            <div class="col-full">
               <div class="pizzaro-breadcrumb">
                  <nav class="woocommerce-breadcrumb" itemprop="breadcrumb">
                     <a href="<?= base_url(''); ?>">Home</a><span class="delimiter"><i class="po po-arrow-right-slider"></i></span>
                     <a href="shop-grid-4-column.html">Category</a>
                     <span class="delimiter"><i class="po po-arrow-right-slider"></i></span>Product title
                  </nav>
               </div>
                     ...
                     <div itemscope itemtype="http://schema.org/Product" id="product-50" class="post-50 product type-product status-publish has-post-thumbnail product_cat-pizza pa_food-type-veg first instock shipping-taxable purchasable product-type-simple addon-product">
                        <div class="single-product-wrapper">
                           <div class="product-images-wrapper">
                              <div class="images">
                                 <a href="assets/images/products/min/p1.jpg" itemprop="image" class="woocommerce-main-image zoom" title="" data-rel="prettyPhoto[product-gallery]">
                                 <img width="600" height="600" src="assets/images/products/min/p1.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" />
                                 </a>
                                 <div class="thumbnails columns-4">
                                    <a href="assets/images/products/min/p1.jpg" class="zoom first" title="" data-rel="prettyPhoto[product-gallery]">
                                    <img width="180" height="180" src="assets/images/products/min/p1.jpg" class="attachment-shop_thumbnail size-shop_thumbnail" alt="" />
                                    </a>
                                    <a href="assets/images/products/min/p2.jpg" class="zoom" title="" data-rel="prettyPhoto[product-gallery]">
                                    <img width="180" height="180" src="assets/images/products/min/p2.jpg" class="attachment-shop_thumbnail size-shop_thumbnail" alt=""/>
                                    </a>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="summary entry-summary">
                              <h1 itemprop="name" class="product_title entry-title">Product title<span class="food-type-icon"><i class="po po-veggie-icon"></i></span></h1>
                                    ...
                                    <div class="product-outer">
                                       <div class="product-inner">
                                          <div class="product-image-wrapper">
                                             ...
                                             <img src="assets/images/products/min/44.jpg" class="img-responsive" alt="">
                                             </a>
                                          </div>
                                 ...
                                 <li class="product ">
                                    <div class="product-outer">
                                       <div class="product-inner">
                                          <div class="product-image-wrapper">
                                             <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                                             <img src="assets/images/products/min/31.jpg" class="img-responsive" alt="">
                                             </a>
                                          </div>
                                          <div class="product-content-wrapper">
                                             <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                                 ...
                                 <li class="product ">
                                    <div class="product-outer">
                                       <div class="product-inner">
                                          <div class="product-image-wrapper">
                                             <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                                             <img src="assets/images/products/min/34.jpg" class="img-responsive" alt="">
                                             </a>
                                          </div>
                                          <div class="product-content-wrapper">
                                             <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                                 ...
                                 <li class="product last">
                                    <div class="product-outer">
                                       <div class="product-inner">
                                          <div class="product-image-wrapper">
                                             <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
                                             <img src="assets/images/products/min/35.jpg" class="img-responsive" alt="">
                                             </a>
                                          </div>
                                          <div class="product-content-wrapper">
                                             <a href="single-product-v1.php" class="woocommerce-LoopProduct-link">
