                  		...
                  		<div class="row profile">
                  			...
                  			<div class="col-md-9 well">
                                 ...
                                 <?php if($error = $this->session->flashdata('feedback'))  :
                                        ...
                                        <?php endif; ?>
                            <div class=""><h2>Add Address:</h2></div>
                  					<form action="<?= base_url('add_address'); ?>" method="POST" class="">
                              <div class="form-group col-md-6">
                                <label for="" class="label-control">Address Title : </label>
                                <input type="text" name="address_title" class="form-control" value="<?php echo set_value('address_title'); ?>">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                echo form_dropdown('address_type', $options, set_value('address_type'), "class='form-control'");
                             ...
                             <!--  <div class="form-group col-md-6"><label for="" class="label-control">Area</label><input type="text" class="form-control"></div>
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <textarea name="address_description" id="" cols="15" rows="3" class="form-control"><?php echo set_value('address_description'); ?></textarea>
